    ...
    filteredProducts.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <div class="product-info">
                ...
                ${product.piecesPerPackage > 1 ? `<p class="price-per-piece">$${pricePerPiece.toFixed(2)} / pieza</p>` : ''}
    ...
    cart.forEach(item => {
        ...
        cartItem.innerHTML = `
            ...
            <div class="cart-item-details">
                ...
                ${item.piecesPerPackage > 1 ? `<p class="cart-item-per-piece">$${pricePerPiece.toFixed(2)} / pieza</p>` : ''}
            </div>
            ...
            ${cart.map(item => `
                <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.75rem;">
                    ...
                    <div style="flex-grow: 1;">
                        ...
                        <p style="margin: 0; font-size: 0.9rem;">Cantidad: ${item.quantity} x $${item.price.toFixed(2)}</p>
                    </div>
